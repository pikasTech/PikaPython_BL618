...
class chart(lv_obj):
    ...
    def add_series(self, color: lv_color_t, axis: int): ...
    # def get_series_next(self, ser: lv_chart_series_t): ...
    # def set_ext_y_array(self, ser: lv_chart_series_t, array: lv_coord_t): ...
